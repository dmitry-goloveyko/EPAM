...
public class SAXAddNoteHandler extends DefaultHandler {
	...
	private final SAXUtilsWithError saxUtils= SAXUtilsWithError.getInstance();
	private Note newNote;
	
	public SAXAddNoteHandler(Note note) {
		newNote = note;
	}
